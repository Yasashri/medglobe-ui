  ...
  const highlightsList = [
    {
      ...
      color: 'green',
      icon: (
        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#28a745" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
    ...
    },
    {
      ...
      color: 'blue',
      icon: (
        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#0b548c" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
